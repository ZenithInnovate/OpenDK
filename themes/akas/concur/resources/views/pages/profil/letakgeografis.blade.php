...
@include('layouts.breadcrumbs', ['title' => 'Letak Geografis'])
            ...
            <div class="col-md-8">
                <div class="page-content">
                    ...
                    <div class="dinamic-single">
                        <div class="title">Letak Geografis {{ strtoupper($sebutan_wilayah) }} {{
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <br>
                                <p style="text-align: justify">{{ ucwords(strtolower($sebutan_wilayah . ' ' . $profil->nama_kecamatan . ', Kabupaten ' .
                                    $profil->nama_kabupaten . ', Provinsi ' . $profil->nama_provinsi)) }} mempunyai <b> Luas {{
                                        number_format($profil->dataumum->luas_wilayah_value) }} km<sup>2</sup></b>
                                ...
                                <h4 class="text-primary">Batas wilayah {{ $sebutan_wilayah }} {{ ucwords(strtolower($profil->nama_kecamatan)) }}
                                    meliputi :</h4>
                                <table>
                                    <tbody>
                                        <tr>
