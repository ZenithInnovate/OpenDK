        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="page-content">
                    ...
                    <div class="dinamic-single">
                        <div id="chart_putus_sekolah" style="width:100%; overflow: visible; text-align: left; padding: 10px;;"></div>
                    </div>

                    <div class="dinamic-single">
                        <div id="chart_fasilitas" style="width:100%;  overflow: visible; text-align: left; padding: 10px;;"></div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        function change_das_pendidikan(did, year) {
            $.ajax({
                url: '{!! route('statistik.pendidikan.chart-tingkat-pendidikan') !!}',
            ...
            $.ajax({
                url: '{!! route('statistik.pendidikan.chart-putus-sekolah') !!}',
                method: 'GET', // Atau 'POST' tergantung kebutuhan
                data: {
                    did: did,
                    y: year
            ...
            $.ajax({
                url: '{!! route('statistik.pendidikan.chart-fasilitas-paud') !!}',
                method: 'GET', // Atau 'POST' tergantung kebutuhan
                data: {
                    did: did,
                    y: year
